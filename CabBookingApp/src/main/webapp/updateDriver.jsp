<%-- 
    ...
    Created on : Sep 21, 2022, 12:28:57 PM
    Author     : ThileebanS
--%>
        ...
        <section id="interface">
            ...
            <%
                ...
                try {
                    ...
                    rs = statement.executeQuery("select * from driver where id ='"+userid+"'");
            ...
            <div class="form-add">
                <form action="updateDriver" method="POST">
                    <table>
                        ...
                        <tr>
                            <td>Username:</td>
                            <td><input type="text" value="<% out.print(rs.getString("name"));%>" id="name" name="name"></td>
                        </tr>
                        <tr>
                            <td>Full name</td>
                            <td><input type="text" value="<% out.print(rs.getString("fullname"));%>" id="fullname" name="fullname"></td>
                        </tr>
                        <%
