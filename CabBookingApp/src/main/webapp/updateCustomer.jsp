<%-- 
    ...
    Created on : Sep 21, 2022, 2:13:40 PM
    Author     : ThileebanS
--%>
        ...
        <section id="interface">
            ...
            <%
                ...
                try {
                    ...
                    rs = statement.executeQuery("select * from customers where cusid ='"+userid+"'");
                ...
                <form action="updateCustomer" method="POST">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input type="hidden" value="<% out.print(rs.getString("cusid"));%>" id="id" name="id"></td>
                        </tr>
                        <tr>
                            <td>Username:</td>
                            <td><input type="text" value="<% out.print(rs.getString("cusname"));%>" id="name" name="name"></td>
                        </tr>
                        <tr>
                            <td>Full name</td>
                            <td><input type="text" value="<% out.print(rs.getString("cusmobile"));%>" id="fullname" name="fullname"></td>
                        </tr>
                        <%
